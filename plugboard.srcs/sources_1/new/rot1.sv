module rotor_I (
    ...
    output logic        notch               // semnal notch pentru rotorul urm?tor
);
    ...
    // setare wiring + notch �n func?ie de tipul rotorului
    always_comb begin
        case(rotor_type)
            2'b00: begin // Rotor I
    ...
    // semnal notch
    assign notch = (position == notch_pos);
